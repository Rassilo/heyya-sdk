...
class FollowController {
     ...
     * @returns {Promise}
     */
    static getFollowControllerGetMyFollowers(limit, page, callback) {
        ...
        const _pathUrl = '/follows/followers';
     ...
     * @returns {Promise}
     */
    static getFollowControllerGetMyFollowings(limit, page, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _pathUrl = '/follows/followings';
        let _queryBuilder = `${_baseUri}${_pathUrl}`;
     ...
     * @returns {Promise}
     */
    static getFollowControllerGetFollows(id, limit, page, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static getFollowControllerFollowUser(id, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static deleteFollowControllerRemoveFollowUser(id, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/follows/remove/{id}';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            id,
        });
